        ...
        <div id="headerarea">
            ...
            <div id="menutab">
                ...
                <div id="mypage_package">
                    <div>
                        <a href="http://localhost:8100/user/reservation/findByName.do">
                    ...
                    <div>
                        <a href="http://localhost:8100/user/payment/findHistoryByName.do">
                ...
                <c:forEach items="${reservation_list}" var="reserve">
	                <div class="reservation">
	                    ...
	                    <a href="reservationDetail/room="+${reserve.room_name}>
	                        <P class="spaceName">${reserve.space_name} / ${reserve.room_name}
	                    </a>
	                    </P>
	                    <c:choose>
...
<script>
    ...
    $('.reservation').on('click','.reviewInsert',function(){
        console.log('여기');
        $(this).after(`<div id="reviewBox">
                        <img src="../resources/css/image/icon/close.png" id="reviewClose">
                        <p>리뷰작성</p>
                        <form action="">
                            <textarea name="review" id="review" maxlength="250" placeholder="후기를 작성해 주세요."></textarea><br>
                            <input type='file' name="file" id="test"/><br>
                            <input type="submit" value="업로드" id="reviewSubmit">
                        </form>
                    </div>`)
    })
    $('.reservation').on('click','#reviewClose', function(){
        $("#reviewBox").detach();
    })
</script>
</html>